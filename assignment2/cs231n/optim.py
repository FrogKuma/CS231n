...
def sgd_momentum(w, dw, config=None):
    ...
    ###########################################################################
    v = -config['learning_rate']*dw + v*config['momentum']
    next_w = w + v
    pass
    ###########################################################################
    #                             END OF YOUR CODE                            #
...
def adam(x, dx, config=None):
    ...
    # stored in config.                                                       #
    ###########################################################################
    first_moment = config['m']*config['beta1'] + (1-config['beta1'])*dx
    second_moment = config['v']*config['beta2'] + (1-config['beta2'])*(dx*dx)
